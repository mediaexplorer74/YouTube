...
namespace LibVLCSharp.Shared
{
    ...
    internal struct LibVLCEvent
    {
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaSubItemTreeAdded
        {
            internal readonly IntPtr MediaInstance;
        }
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaPlayerChapterChanged
        {
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaPlayerVoutChanged
        {
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaListWillAddItem
        {
            internal readonly IntPtr MediaInstance;
            internal readonly int Index;
        }
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaListItemDeleted
        {
            internal readonly IntPtr MediaInstance;
            internal readonly int Index;
        }
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaListWillDeleteItem
        {
            internal readonly IntPtr MediaInstance;
            internal readonly int Index;
        }
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct MediaListPlayerNextItemSet
        {
            internal readonly IntPtr MediaInstance;
        }
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct RendererDiscovererItemAdded
        {
            internal readonly IntPtr item;
        }

        [StructLayout(LayoutKind.Sequential)]
        internal struct RendererDiscovererItemDeleted
        {
            internal readonly IntPtr item;
        }
    }
